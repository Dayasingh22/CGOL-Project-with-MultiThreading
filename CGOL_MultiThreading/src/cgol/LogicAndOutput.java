...
public class LogicAndOutput extends Thread {
	
	private int r, c;
	private int[][] arr ;
	private int[][] futureLife = new int[100][100];

	public LogicAndOutput(int r, int c, int[][] arr) {
		this.r=r;
		this.c=c;
		this.arr = arr;
	}
	...
	public void run() {
        ...
        System.out.println("Enter the y for continuing the game and other character for ending the game: ");
	}
